...
import MessagePage from '../pages/room/MessagePage.vue'
...
import ChatPage from '../pages/room/ChatRoomPage.vue'
...
const routes = [
    ...
    {path: '/chat', component: ChatPage, meta: {navBar: false, vanTabbar: false, title: '测试'}},
]
